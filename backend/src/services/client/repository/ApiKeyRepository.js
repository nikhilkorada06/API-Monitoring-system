...
class MongoApiKeyRepository extends BaseApiKeyRepository {
    ...
    /**
     * Find API key with its key value
     ...
     */
    async findAllByClientId(clientId, filters = {}) {
        try {
            ...
            const apiKeys = await this.model.find(query)
                ...
                );  //populate createdBy field with username and email, and sort by createdAt in descending order
